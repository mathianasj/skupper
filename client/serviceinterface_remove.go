...
func handleServiceCertificateRemoval(address string, cli *VanClient) {
	...
	secret, err := cli.KubeClient.CoreV1().Secrets(cli.Namespace).Get(context.TODO(), certName, metav1.GetOptions{})
	...
	if err == nil && secret != nil {
		...
		err = cli.KubeClient.CoreV1().Secrets(cli.Namespace).Delete(context.TODO(), secret.Name, metav1.DeleteOptions{})
